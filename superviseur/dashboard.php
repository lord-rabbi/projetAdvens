...
function getLibelleStatut($statut)
{
    switch ($statut) {
        ...
        case 'pending_superviseur':
            return 'Attente validation superviseur';
        ...
        <div class="row">
            <div class="sidebar">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?php echo $onglet == 'valider' ? 'active' : ''; ?>" href="dashboard.php?onglet=valider">
                            <i class="fas fa-check-circle me-2"></i> Demandes à valider
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $onglet == 'historique' ? 'active' : ''; ?>" href="dashboard.php?onglet=historique">
            ...
            <div class="content">
                ...
                <?php if ($onglet == 'historique'): ?>
                    <div class="card">
                        ...
                        <?php if ($total_pages_histo > 1): ?>
                        <div class="pagination-container">
                            <div class="pagination-info">
                                Page <?php echo $page; ?> sur <?php echo $total_pages_histo; ?> (<?php echo $total_histo; ?> demandes)
                            </div>
                            <ul class="pagination">
                                <?php if ($page > 1): ?>
                                    <li><a href="?onglet=historique&page=<?php echo $page - 1; ?>">« Précédent</a></li>
                                <?php else: ?>
                                    <li class="disabled"><span>« Précédent</span></li>
                                <?php endif; ?>

                                <?php for ($i = 1; $i <= $total_pages_histo; $i++): ?>
                                    <?php if ($i == $page): ?>
                                        <li class="active"><span><?php echo $i; ?></span></li>
                                    <?php else: ?>
                                        <li><a href="?onglet=historique&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php endif; ?>
                                <?php endfor; ?>

                                <?php if ($page < $total_pages_histo): ?>
                                    <li><a href="?onglet=historique&page=<?php echo $page + 1; ?>">Suivant »</a></li>
                                <?php else: ?>
                ...
                <?php else: ?>
                    <div class="card">
                        ...
                        <div class="pagination-container">
                            ...
                            <ul class="pagination">
                                <?php if ($page > 1): ?>
                                    <li><a href="?onglet=valider&page=<?php echo $page - 1; ?>">« Précédent</a></li>
                                <?php else: ?>
                                    <li class="disabled"><span>« Précédent</span></li>
                                <?php endif; ?>
                                ...
                                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                    <?php if ($i == $page): ?>
                                        <li class="active"><span><?php echo $i; ?></span></li>
                                    <?php else: ?>
                                        <li><a href="?onglet=valider&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php endif; ?>
                                <?php endfor; ?>

                                <?php if ($page < $total_pages): ?>
                                    <li><a href="?onglet=valider&page=<?php echo $page + 1; ?>">Suivant »</a></li>
                                <?php else: ?>
                                    <li class="disabled"><span>Suivant »</span></li>
                                <?php endif; ?>
                            </ul>
